...
(function(){
    ...
    //Variables ---------------------------------
        ...
        const SlideLeft = document.getElementById('Contact-IntroSlideLeft');
        const SlideRight = document.getElementById('Contact-IntroSlideRight');
        ...
        const AboutInScene = new TimelineMax();
            AboutInScene
                ...
                .add('wave2')
                    ...
                    .to(ContactIntro, .01, {display: 'none'})
